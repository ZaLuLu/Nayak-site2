...
export const DIVISIONS: DivisionItem[] = [
  {
    ...
    shortTitle: 'Products',
    tagline: 'Tools Built for Developers & Builders',
    description: 'Interactive tools we build and maintain for developers. Algorithm visualizers, memory inspectors, and global tech event discovery.',
    route: '/products',
    badge: 'Our Products',
    accentColor: '#8B5CF6',
    gradient: 'from-violet-500/20 to-purple-500/5',
    tags: ['#DeveloperTools', '#AlgorithmVisualizer', '#EventMesh', '#Learning'],
    metrics: [
