...
export function TabletWhyChooseUs() {
  ...
  return (
    <section id="why-us" className="w-full px-6 sm:px-8 py-14 border-t border-[var(--border-base)] scroll-mt-20 select-none">
      ...
      <div className="grid grid-cols-12 gap-5">
          ...
          {WORKFLOW_STEPS.map((step, idx) => {
            ...
            return (
              <button
                ...
                className={`w-full p-3.5 rounded-xl border text-left flex items-center justify-between transition-all duration-200 active:scale-[0.98] cursor-pointer ${
                  isActive
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-display font-bold text-xs sm:text-sm text-[var(--text-primary)]">
                      {step.title}
                    </div>
        ...
        <div className="col-span-7 p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-base)] flex flex-col justify-between shadow-md shadow-black/5">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <span className="font-mono text-[10px] uppercase tracking-wider text-violet-400 font-bold">
                    {activeStep.badge}
                  </span>
              ...
              <span className="font-mono text-xs px-2.5 py-0.5 rounded-md bg-[var(--bg-surface)] border border-[var(--border-base)] text-[var(--text-secondary)] font-semibold">
                {activeStep.timeline}
              </span>
            </div>
            ...
            <div>
              <div className="font-mono text-[10.5px] uppercase tracking-wider text-[var(--text-muted)] font-bold mb-2.5">
                Phase Deliverables & Artifacts
              </div>
              <div className="space-y-2">
                {activeStep.deliverables.map((d) => (
                  <div key={d} className="flex items-center gap-2 font-body text-xs text-[var(--text-primary)]">
          ...
          <div className="pt-4 border-t border-[var(--border-base)] flex items-center justify-between font-mono text-xs text-[var(--text-muted)] mt-5">
